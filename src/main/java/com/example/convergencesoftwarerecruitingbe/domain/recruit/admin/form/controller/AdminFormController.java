package com.example.convergencesoftwarerecruitingbe.domain.recruit.admin.form.controller;

import com.example.convergencesoftwarerecruitingbe.domain.recruit.admin.form.dto.request.AdminFormCreateRequest;
import com.example.convergencesoftwarerecruitingbe.domain.recruit.admin.form.dto.request.AdminFormResultOpenRequest;
import com.example.convergencesoftwarerecruitingbe.domain.recruit.admin.form.dto.response.AdminFormListItemResponse;
import com.example.convergencesoftwarerecruitingbe.domain.recruit.admin.form.dto.response.AdminFormResponse;
import com.example.convergencesoftwarerecruitingbe.domain.recruit.admin.form.dto.response.AdminFormResultOpenResponse;
import com.example.convergencesoftwarerecruitingbe.domain.recruit.admin.form.service.AdminFormService;
...
public class AdminFormController implements AdminFormControllerDocs {
    ...
    public ResponseEntity<Void> delete(
        ...
        adminFormService.deleteForm(id);
        return ResponseEntity.noContent().build();
    }
}
